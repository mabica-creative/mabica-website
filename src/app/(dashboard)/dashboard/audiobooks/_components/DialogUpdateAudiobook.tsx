        ...
        >
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Input id="slug" required defaultValue={data?.slug} disabled />
            </div>
            <div className="flex flex-col gap-4">
              <Label htmlFor="image">Image</Label>
              <Input id="image" required defaultValue={data?.imageUrl} />
            </div>
            <div className="flex flex-col gap-4">
              <Label htmlFor="synopsis">Synopsis</Label>
              <Textarea id="synopsis" required defaultValue={data?.synopsis} />
            </div>
          </div>
          <DialogFooter>
            <DialogClose>
